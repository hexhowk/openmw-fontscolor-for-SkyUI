---
-- `openmw.shader` is an interface to postprocessing shaders.
-- Can be used only by local scripts, that are attached to a player.
-- @module shader
-- @usage local shader = require('openmw.shader')



---
-- Load a shader and return its handle.
-- @function [parent=#shader] load
...
-- local vignetteShader = shader.load('vignette')
...
-- @usage
-- local shader = require('openmw.shader')
